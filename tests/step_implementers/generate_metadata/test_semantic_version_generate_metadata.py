...
def test_no_provided_app_version():
...
def test_no_provided_pre_release():
    with TempDirectory() as temp_dir:
        repo = Repo.init(str(temp_dir.path))
...
def test_maven_git_and_version_master_branch():
    with TempDirectory() as temp_dir:
        repo = Repo.init(str(temp_dir.path))
...
def test_maven_git_and_version_feature_branch():
    with TempDirectory() as temp_dir:
        repo = Repo.init(str(temp_dir.path))
...
def test_override_app_version_at_runtime():
    with TempDirectory() as temp_dir:
        repo = Repo.init(str(temp_dir.path))
...
def test_override_build_at_runtime():
    with TempDirectory() as temp_dir:
        repo = Repo.init(str(temp_dir.path))
...
def test_override_pre_release_at_runtime():
    with TempDirectory() as temp_dir:
        repo = Repo.init(str(temp_dir.path))
