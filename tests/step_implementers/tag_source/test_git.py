...
class TestStepImplementerTagSourceGit(BaseStepImplementerTestCase):
    @staticmethod
    def __create_git_step_implementer(git_mock, step_config={}):
        config = Config({
            ...
            expected_step_results = {
                'tag-source': {
                    'Git': {
                        ...
                        'message': '',
                        'artifacts': {
                            'tag': {'description': '', 'type': 'str', 'value': 'latest'}
                        }
                    }
                }
            }
            ...
            expected_step_results = {
                'tag-source': {
                    'Git': {
                        ...
                        'message': '',
                        'artifacts': {
                            'tag': {'description': '', 'type': 'str', 'value': '1.0+69442c8'}
                        }
                    }
                }
            }
                ...
                'tssc-results': {
                    'generate-metadata': {
                        'Git': {
                            ...
                            'artifacts': {
                                'version': {'value': '1.0+69442c8'},
                                'container-image-version': {'value': '1.0+69442c8'},
                            }
                        }
                    }
                }
    ...
    def test__git_tag_invalid_git_credentials(self, git_mock):
        ...
        git_mock.tag.side_effect = sh.ErrorReturnCode(
            'git tag', b'mock out', b'mock authentication error')
